...
public class LightsTests {
    ...
    public void sphereDirectional() {
        ...
        scene.set_background(new primitives.Color(Color.BLACK));
        scene.set_ambientLight(new AmbientLight(new primitives.Color(Color.BLACK), 0));
    ...
    public void trianglesDirectional() {
        ...
        scene.addGeometries(
                new Triangle(new primitives.Color(Color.BLACK), new Material(0.8, 0.2, 300),
    ...
    public void trianglesPoint() {
        ...
        scene.addGeometries(
                new Triangle(Color.BLACK, new Material(0.5, 0.5, 300),
                        new Point3D(-150, 150, 150), new Point3D(150, 150, 150), new Point3D(75, -75, 150)),
                new Triangle(new primitives.Color(Color.BLACK), new Material(0.5, 0.5, 300),
                        new Point3D(-150, 150, 150), new Point3D(-70, -70, 50), new Point3D(75, -75, 150)));
