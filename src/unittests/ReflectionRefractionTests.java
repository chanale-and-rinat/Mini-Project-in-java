...
public class ReflectionRefractionTests {
	...
	public void ourTest() {
		...
		scene.addGeometries(
				new Plane(new Color(0,0,100), new Material(0.25, 0.25, 20),new Point3D(0,0,30000),new Vector(0,0,1)),
				new Sphere(new Color(0, 100, 0), new Material(0.25, 0.25, 20, 0.5, 0), 400, new Point3D(-950, 900, 1000)),
				new Sphere(new Color(100, 20, 20), new Material(0.25, 0.25, 20), 400, new Point3D(-900, 900, 1500)),
				new Triangle(new Color(20, 20, 20), new Material(0, 0, 0, 0, 1), new Point3D(3000, 3000, 1500),
						new Point3D(-1000, -800, 1500), new Point3D(670, -670, -3000)));
